...
class Author(models.Model):
    ...
    display_name = models.CharField(max_length=MAX_LENGTH, null=True)
    host = models.URLField(max_length=MAX_LENGTH, null=True)
    github = models.URLField(max_length=MAX_LENGTH, blank=True, null=True)
    profile_url = models.URLField(max_length=MAX_LENGTH,null=True) 
    profile_image = models.URLField(max_length=MAX_LENGTH, null=True)
