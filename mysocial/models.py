...
class Author(models.Model):
    ...
    url_id = models.URLField(max_length=MAX_LENGTH, unique=True, null=False, blank=False)
...
class Post(models.Model):
    ...
    url_id = models.URLField(max_length=MAX_LENGTH, unique=True, null=False, blank=False)
    post_id = models.UUIDField(max_length=MAX_LENGTH, unique=True, null=True, blank=True)
